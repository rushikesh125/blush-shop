  ...
  return (
    <nav className="sticky z-50 top-0 border border-b border-gray-800/[0.10] text-black bg-white  sm:px-4 py-3 flex gap-x-2 items-center justify-between">
      ...
      <div className="flex  mx-1 md:mx-2 ">
        <button className=" mx-1 md:mx-2 hover:text-pink-400">
          <svg
        ...
        <button className=" mx-1 md:mx-2 hover:text-pink-400 hidden md:block">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
        ...
        <Link
          href={`/auth`}
          className="  rounded-full text-black px-3 py-1  mx-1 md:mx-2 hover:text-pink-400"
        >
          Login
          <svg
            xmlns="http://www.w3.org/2000/svg"
